    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          options.UseSqlServer(Configuration.GetSection("SqlConnection:ConnectionString").Value));
            // register repos
            services.AddScoped<IStudnentRepository, StudentRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "T_System_Web_Api", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "T_System_Web_Api v1"));
            }
